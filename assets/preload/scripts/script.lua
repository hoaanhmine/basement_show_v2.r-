...
function onCreatePost()
     ...
     makeLuaText('maxcobo', '  ', 350, x, y + Text.Size)
     makeLuaText('cobo', '  ', 300, x, y + Text.Size*2)
     makeLuaText('W', '  ', 300, x, y + Text.Size*3)
     makeLuaText('O', '  ', 300, x, y + Text.Size*4)
     makeLuaText('N', '  ', 300, x, y + Text.Size*5)
     makeLuaText('SU', '  ', 300, x, y + Text.Size*6)
  end
end
